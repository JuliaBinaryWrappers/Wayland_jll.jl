...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Wayland_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("a2964d1f-97da-50d4-b82a-358c7fce9d89"))
...
if best_platform === nothing
    @debug("Unable to load Wayland; unsupported platform $(triplet(platform_key_abi()))")
else
